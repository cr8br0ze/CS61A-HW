...
def totals_tree(m):
    ...
    return tree(total_weight(m), [totals_tree(end(lor(m))) for lor in leftorright])
...
def check_par():
    ...
    True
    """
    r1 = interval(1, 99)  # Replace this line!
    r2 = interval(100, 199)  # Replace this line!
    return r1, r2
